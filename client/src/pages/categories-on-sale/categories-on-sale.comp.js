...
import './categories-on-sale.styles.scss';

const CategoriesOnSale = ({ match }) => {
  const { params } = match;
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    axios.get(`/api/v1/categories/on-sale/product/${params.id}`).then((res) => {
  ...
  return (
    <>
      <div className="custom-container categpries-on-sale-page-wrapper">
...
export default CategoriesOnSale;
