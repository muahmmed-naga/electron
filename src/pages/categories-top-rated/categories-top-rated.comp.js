...
import './categories-top-rated.styles.scss';

const CategoriesTopRated = ({ match }) => {
  const { params } = match;
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    axios
      .get(`/api/v1/categories/top-rated/product/${params.id}`)
      .then((res) => {
  ...
  return (
    <>
      <div className="custom-container categpries-top-rated-page-wrapper">
